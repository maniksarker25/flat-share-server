...
const convertSrtingToBoolean_1 = __importDefault(
  require("../../helpers/convertSrtingToBoolean")
);
const createFlatIntoDB = (userId, payload) =>
...
const getFlatsFromDB = (query, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // destructure limit and skip
    const convertStringToBoolean = (0, convertSrtingToBoolean_1.default)(query);
    const { page, limit, skip } = (0, paginatonHelper_1.calculatePagination)(
      options
    );
    const { searchTerm } = convertStringToBoolean,
      filterData = __rest(convertStringToBoolean, ["searchTerm"]);
    ...
    if (query === null || query === void 0 ? void 0 : query.searchTerm) {
      andConditions.push({
        OR: flat_constant_1.flatSearchableFields.map((field) => ({
          [field]: {
            contains:
              query === null || query === void 0 ? void 0 : query.searchTerm,
            mode: "insensitive",
          },
        })),
      });
    ...
    // }
    if (
      filterData === null || filterData === void 0
        ? void 0
        : filterData.totalBedrooms
    ) {
      andConditions.push({
        totalBedrooms: {
          equals:
...
// get single flat
const getSingleFlatFromDB = (flatId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
// update flat into db
const updateFlatIntoDB = (flatId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const flat = yield prisma_1.default.flat.findUnique({
      where: {
        id: flatId,
