...
const registerUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.userService.registerUserIntoDB(
      req.body
    );
...
const getUserProfile = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.userService.getUserProfileFromDB(
      userId
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateUserProfileIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.id;
    const result = yield user_service_1.userService.updateUserProfileIntoDB(
      userId,
      req.body
    );
    (0, sendResponse_1.default)(res, {
...
const changeUserStatus = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.userService.changeUserStatusIntoDB(
      userId,
      status
    );
    (0, sendResponse_1.default)(res, {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userId =
      ...
      _c === void 0
        ? void 0
        : _c.id;
    const result = yield user_service_1.userService.changePasswordIntoDB(
      userId,
      req.body
    );
    (0, sendResponse_1.default)(res, {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userId =
      ...
      _d === void 0
        ? void 0
        : _d.id;
    const result = yield user_service_1.userService.updateProfileIntoDB(
      userId,
      req.body
    );
    (0, sendResponse_1.default)(res, {
